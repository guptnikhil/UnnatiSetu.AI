...
export default function AdminDashboard() {
  ...
  const INITIAL_APPLICANTS = [
    ...
    { id: "APP-2026-8806", name: "Kavita Paswan", gender: "Female", category: "SC", annual_income: 110000, state: "Madhya Pradesh", district: "Bhopal", business_type: "E-Rickshaw", loan_amount_requested: 250000, matched_scheme_id: "SCH_GBS", matched_partner_id: "CP_MP_SCA_01", status: "Matched", stuck_alert: false, intake_transcript: "मैं कविता पासवान भोपाल से हूँ। मुझे ई-रिक्शा चलाने के लिए ₹2.5 लाख का लोन चाहिए।" },
    { id: "APP-2026-8807", name: "Vikas Gautam", gender: "Male", category: "SC", annual_income: 180000, state: "Uttar Pradesh", district: "Agra", business_type: "Micro Enterprise", loan_amount_requested: 140000, matched_scheme_id: "SCH_MCS", matched_partner_id: "CP_UP_SCA_01", status: "Under Review", stuck_alert: false, intake_transcript: "I am Vikas Gautam from Agra. I need ₹1.4 Lakh loan to buy raw materials for shoe handicraft enterprise." },
    { id: "APP-2026-8808", name: "Meena Jatav", gender: "Female", category: "SC", annual_income: 135000, state: "Rajasthan", district: "Jaipur", business_type: "Dairy/Agri", loan_amount_requested: 180000, matched_scheme_id: "SCH_MKY", matched_partner_id: "CP_UP_SCA_01", status: "Pending Docs", stuck_alert: true, intake_transcript: "मैं मीना जाटव जयपुर से हूँ। डेयरी और मुर्गी पालन के लिए ₹1,80,000 लोन की आवश्यकता है।" },
    { id: "APP-2026-8809", name: "Sanjay Kadam", gender: "Male", category: "SC", annual_income: 240000, state: "Maharashtra", district: "Pune", business_type: "Transport", loan_amount_requested: 750000, matched_scheme_id: "SCH_TLS", matched_partner_id: "CP_MH_SCA_01", status: "Disbursed", stuck_alert: false, intake_transcript: "I am Sanjay Kadam from Pune. I received ₹7.5 Lakh Term Loan for small fabrication workshop." },
    { id: "APP-2026-8810", name: "Aarti Naskar", gender: "Female", category: "SC", annual_income: 90000, state: "West Bengal", district: "Kolkata", business_type: "Micro Enterprise", loan_amount_requested: 100000, matched_scheme_id: "SCH_MSY", matched_partner_id: "CP_DL_SBI_01", status: "New", stuck_alert: false, intake_transcript: "আমি আরতি নস্কর, কলকাতা থেকে। হস্তশিল্প ও ছোট মোদী দোকানের জন্য ₹১,০০,০০০ ঋণ চাই।" }
  ];
